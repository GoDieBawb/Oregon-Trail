 ...
 * @author Bawb
 */
public class FerrymanGui extends Gui {
    ...
    private void showInfo() {
        Player player = getStateManager().getState(PlayerManager.class).getPlayer();
        player.getHud().showAlert("Ferry", "The Ferryman will take your wagon across for $25" + System.getProperty("line.separator") + "Current Money: $" + player.getInventory().get("Money"));
    }
    
    private void createYesButton() {
        
        yesButton = new ButtonAdapter(getScreen(), "Ferryman Yes Button", new Vector2f(12,12)) {
    ...
    private void createNoButton() {
        ...
        noButton = new ButtonAdapter(getScreen(), "Ferryman No Button", new Vector2f(12,12)) {
    ...
    private void createInteractButton() {
        ...
        interactButton = new ButtonAdapter(getScreen(), "Ferryman Interact Button", new Vector2f(12,12)) {
